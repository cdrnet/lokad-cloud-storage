...
namespace Lokad.Cloud.Samples.MapReduce
{
	...
	public sealed class MapReduceBlobSet
	{
		...
		public T GetAggregatedResult<T>(string jobName)
		{
			...
			if (completedBlobsets < config.Value.BlobSetCount) throw new InvalidOperationException("Job is not complete (there still are blobsets to process)");
		...
		public class MapReduceConfigurationName : BlobName<MapReduceConfiguration>
		{
		...
		private class InputBlobName : BlobName<object>
		{
			public override string ContainerName
			{
				get { return MapReduceBlobSet.ContainerName; }
		...
		private class ReducedBlobName : BlobName<object>
		{
			public override string ContainerName
			{
				get { return MapReduceBlobSet.ContainerName; }
		...
		private class AggregatedBlobName : BlobName<object>
		{
			public override string ContainerName
			{
				get { return MapReduceBlobSet.ContainerName; }
		...
		private class BlobCounterName : BlobName<decimal>
		{
			public override string ContainerName
			{
				get { return MapReduceBlobSet.ContainerName; }
