...
namespace Lokad.Cloud.Framework
{
	...
	public class BlobSet<T> : IEnumerable<T>
	{
		...
		/// <remarks>The <see cref="Id"/> is autogenerated based on the type <see cref="T"/>.</remarks>
		public BlobSet()
		{
			throw new NotImplementedException();
		}

		/// <summary>Constructor that specifies the <see cref="Id"/>.</summary>
		public BlobSet(string blobSetId)
		{
			throw new NotImplementedException();
		}
		...
		/// <typeparam name="M">Output type of the termination message.</typeparam>
		/// <param name="mapper">Mapping function (should be serializable).</param>
		/// <param name="mappingQueueId">Identifier of the queue where items will be put.</param>
		/// <param name="messageQueueId">Identifier of the queue where the termination message is put.</param>
		/// <remarks>
		/// This method is asynchronous.
		/// </remarks>
		public void MapToQueue<U, M>(
			Func<BlobId, U> mapper, M onCompleted, string mappingQueueId, string messageQueueId)
		{
			throw new NotImplementedException();
		}
		...
		/// <param name="queueId">Identifier the output queue.</param>
		public void ReduceToQueue<U>(Func<U,U,U> reducer, string queueId)
		{
			throw new NotImplementedException();
		}
